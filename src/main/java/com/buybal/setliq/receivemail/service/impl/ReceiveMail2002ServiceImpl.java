...
public class ReceiveMail2002ServiceImpl implements ReceiveMailService {

	private static Logger logger = LoggerFactory.getLogger(ReceiveMail2002ServiceImpl.class);
